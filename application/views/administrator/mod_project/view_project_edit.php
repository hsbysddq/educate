    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit project Terpilih</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart($this->haladmin . '/edit_listproject',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Link Download</th>          <td><input type='text' class='form-control' name='y' value='$rows[linkdownload]'></td></tr>
                    <tr><th scope='row'>Link Demo</th>          <td><input type='text' class='form-control' name='z' value='$rows[linkdemo]'></td></tr>
                    ...
                    <tr><th scope='row'>Free ? </th>        <td>"; if ($rows['free']=='Y'){ echo "<input type='radio' name='f' value='Y' checked> Ya &nbsp; <input type='radio' name='f' value='N'> Tidak"; }else{ echo "<input type='radio' name='f' value='Y'> Ya &nbsp; <input type='radio' name='f' value='N' checked> Tidak"; } echo "</td></tr>
                    <tr><th scope='row'>project Utama</th>           <td>"; if ($rows['utama']=='Y'){ echo "<input type='radio' name='g' value='Y' checked> Ya &nbsp; <input type='radio' name='g' value='N'> Tidak"; }else{ echo "<input type='radio' name='g' value='Y'> Ya &nbsp; <input type='radio' name='g' value='N' checked> Tidak"; } echo "</td></tr>
                    <tr><th scope='row'>Isi project</th>             <td><textarea id='editor1' class='form-control' name='h' style='height:260px' required>$rows[isi_project]</textarea></td></tr>
                    <tr><th scope='row'>File Size</th>          <td><input type='text' class='form-control' name='x' value='$rows[filesize]'></td></tr>
					<tr><th scope='row'>Ganti Gambar</th>                 <td><input type='file' class='form-control' name='k'>";
                                                                               if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href='".base_url()."asset/foto_project/$rows[gambar]'>$rows[gambar]</a>"; } echo "</td></tr>
