<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->haladmin . '/edit_video',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Durasi (menit)</th>               <td><input type='number' class='form-control' name='m' value='$rows[durasi]'></td></tr>
