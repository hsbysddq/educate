<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->haladmin . '/edit_manajemenmodul',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Link</th>                       <td style='color:red;'><b>".base_url()."$this->haladmin/</b> <input type='text' class='form-control' name='b' value='$rows[link]' style='width:50%; display:inline-block' required></td></tr>
