<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->haladmin . '/tambah_manajemenuser',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Level</th>                   <td><input type='radio' name='g' value='kontributor' checked> Kontributor &nbsp; <input type='radio' name='g' value='user'> User Biasa &nbsp; <input type='radio' name='g' value='admin'> Administrator</td></tr>
