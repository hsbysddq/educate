<?php
    ...
    echo "<div class='col-md-6'>
          <div class='box'>
            ...
            <div class='box-body'>
              ...
              <div class='alert alert-success alert-dismissible'>
                ...
                Diharapkan informasi akun sesuai dengan identitas pada Kartu Pengenal anda, Untuk Mengubah informasi Profile anda klik <a href='".base_url()."$this->haladmin/edit_manajemenuser/".$this->session->username."'>disini</a>.
              </div>
            </div>
          </div>
        </div>
        ...
        $feedlist = new rss('http://www.lokomedia.web.id/sitemap.xml'); /* Ubah link feed disini dengan link feed Anda */
